...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Extracción de piezas útiles}
...
Luego de realizar todos los pasos anteriormente mencionados se obtendrá como resultado un modelo terminado y listo para trabajar, como el mostrado en la figura \ref{fig:robotlisto}. Finalmente, terminado el modelamiento de las plataformas robóticas en el simulador es posible iniciar los entrenamientos para generar las caminatas en los robots, lo cual será relatado en el siguiente capítulo.
