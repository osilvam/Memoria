...
\item Repetir hasta encontrar una solución:
	...
	\item Por cada miembro de la población de redes CPPN:
		...
		\item Usar la red CPPN para determinar el peso y el retardo de cada posible conexión en el substrato. Si el valor absoluto de la salida correspondiente al peso de la red CPPN sobrepasa la magnitud de un umbral, se crea la conexión con el peso y el porcentaje de retardo dado por la salida de la red CPPN.
