...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=\textwidth]{fig/QUADRATOT_FITNESS.eps}
    \caption{\textbf{Gráfico comparativo del desempeño entre HyperNEAT y \(\tau\)-HyperNEAT.} HOAOAOAOAOAOA.}
    \label{fig:quadratot_fitness}	
\end{figure}

Gráfico Joint Positions HyperNEAT

\begin{figure}[ht!]
	\centering
	\includegraphics[width=\textwidth]{fig/QUADRATOT_JP_HYPERNEAT.eps}
    \caption{\textbf{Posición de los motores de Quadratot dada por HyperNEAT.} HOAOAOAOAOAOA.}
    \label{fig:quadratot_jp_hyperneat}	
\end{figure}

Gráfico Joint Positions \(\tau\)-HyperNEAT

\begin{figure}[ht!]
	\centering
	\includegraphics[width=\textwidth]{fig/QUADRATOT_JP_TAUHYPERNEAT.eps}
    \caption{\textbf{Posición de los motores de Quadratot dada por \(\tau\)-HyperNEAT.} HOAOAOAOAOAOA.}
    \label{fig:quadratot_jp_tauhyperneat}	
\end{figure}

Gráfico Robot Position HyperNEAT

\begin{figure}[ht!]
	\centering
	\includegraphics[width=\textwidth]{fig/QUADRATOT_POSITION_HYPERNEAT.eps}
    \caption{\textbf{Desplazamiento de Quadratot en el escenario dado por HyperNEAT.} HOAOAOAOAOAOA.}
    \label{fig:quadratot_p_hyperneat}	
\end{figure}

Gráfico Robot Position \(\tau\)-HyperNEAT

\begin{figure}[ht!]
	\centering
	\includegraphics[width=\textwidth]{fig/QUADRATOT_POSITION_TAUHYPERNEAT.eps}
    \caption{\textbf{Desplazamiento de Quadratot en el escenario dado por \(\tau\)-HyperNEAT.} HOAOAOAOAOAOA.}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=\textwidth]{fig/ARGOV2_FITNESS.eps}
    \caption{\textbf{Gráfico comparativo del desempeño entre HyperNEAT y \(\tau\)-HyperNEAT.} HOAOAOAOAOAOA.}
...
\begin{figure}[ht!]
    ...
    \caption{\textbf{Posición de los motores de ArgoV2 dada por HyperNEAT.} HOAOAOAOAOAOA.}
...
\begin{figure}[ht!]
    ...
    \caption{\textbf{Posición de los motores de ArgoV2 dada por \(\tau\)-HyperNEAT.} HOAOAOAOAOAOA.}
...
\begin{figure}[ht!]
    ...
    \caption{\textbf{Desplazamiento de ArgoV2 en el escenario dado por HyperNEAT.} HOAOAOAOAOAOA.}
...
\begin{figure}[ht!]
    ...
    \caption{\textbf{Desplazamiento de ArgoV2 en el escenario dado por \(\tau\)-HyperNEAT.} HOAOAOAOAOAOA.}
