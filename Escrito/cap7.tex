...
\begin{figure}[ht!]
	\centering
		...
		\centering
        \includegraphics[width=\textwidth]{fig/L1_QUADRATOT.png}
        \caption{Distribución de diagramas (b) y (c)}
        \label{fig:quadratotthcon1}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.3\textwidth}
		\centering
        \includegraphics[width=0.88\textwidth]{fig/L1W_QUADRATOT.png}
        \caption{Pesos hacia la capa intermedia}
        \label{fig:quadratotthcon2}
    \end{subfigure}
    ~
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
    	\includegraphics[width=0.88\textwidth]{fig/L1T_QUADRATOT.png}
    	\caption{Retardos hacia la capa intermedia}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
    	\centering
        \includegraphics[width=\textwidth]{fig/L2_QUADRATOT.png}
        \caption{Distribución de diagramas (e) y (f)}
        \label{fig:quadratotthcon4}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.3\textwidth}
    	\centering
        \includegraphics[width=0.88\textwidth]{fig/L2W_QUADRATOT.png}
        \caption{Pesos hacia la capa de salida}
        \label{fig:quadratotthcon5}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.3\textwidth}
    	\centering
        \includegraphics[width=0.88\textwidth]{fig/L2T_QUADRATOT.png}
        \caption{Retardos hacia la capa de salida}
        \label{fig:quadratotthcon6}
    \end{subfigure}
    \caption{\textbf{Diagramas de conexión del substrato de \(\tau\)-HyperNEAT para el robot Quadratot.} La figura muestra cuatro diagramas (b,c,e,f) correspondientes a los pesos y retardos asociados a las conexiones en el substrato entre la capa de entrada e intermedia, y entre la capa intermedia y de salida. En cada diagrama, el pixel ($i,j$) representa el peso, o el retardo según sea el caso, de la conexión desde el nodo $i$-ésimo de la capa origen hacia el nodo $j$-ésimo de la capa destino, como se indica en (a) y (d).}
...
\begin{figure}[ht!]
	...
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
        \includegraphics[width=\textwidth]{fig/L1_ARGOV2.png}
        \caption{Distribución de diagramas (b) y (c)}
        \label{fig:argov2thcon1}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.3\textwidth}
		\centering
        \includegraphics[width=0.88\textwidth]{fig/L1W_ARGOV2.png}
        \caption{Pesos hacia la capa intermedia}
	...
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
    	\includegraphics[width=0.88\textwidth]{fig/L1T_ARGOV2.png}
    	\caption{Retardos hacia la capa intermedia}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
    	\centering
        \includegraphics[width=\textwidth]{fig/L2_ARGOV2.png}
        \caption{Distribución de diagramas (e) y (f)}
        \label{fig:argov2thcon4}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.3\textwidth}
    	\centering
        \includegraphics[width=0.88\textwidth]{fig/L2W_ARGOV2.png}
        \caption{Pesos hacia la capa de salida}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
    	\centering
        \includegraphics[width=0.88\textwidth]{fig/L2T_ARGOV2.png}
        \caption{Retardos hacia la capa de salida}
