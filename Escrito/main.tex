...
\textbf{\Large ``\(\tau\)-HYPERNEAT: RETARDOS DE TIEMPO EN UNA RED HYPERNEAT PARA APRENDIZAJE DE CAMINATAS EN ROBOTS CON EXTREMIDADES MÓVILES''\\}
\vspace{3cm}

\hangindent=0cm\large \textbf{OSCAR ANDRÉ SILVA MUÑOZ}\\
\vspace{0.5cm}
\hangindent=0cm\normalsize \textbf{MEMORIA DE TITULACIÓN PARA OPTAR AL TÍTULO DE INGENIERO CIVIL
ELECTRÓNICO, MENCIÓN COMPUTADORES}\\
\vspace{1cm}
\hangindent=0cm\normalsize \textbf{PROFESOR GUIA: \hspace{2cm} MARÍA JOSÉ ESCOBAR SILVA.}\\
\vspace{0.5cm}
