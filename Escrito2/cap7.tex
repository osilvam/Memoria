...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
		\centering
        \includegraphics[width=0.92\textwidth]{fig/L1W_ARGOV2.png}
        \caption{Pesos hacia capa intermedia}
	...
	\begin{subfigure}[b]{0.33\textwidth}
		\centering
    	\includegraphics[width=0.84\textwidth]{fig/L1T_ARGOV2.png}
    	\caption{Retardos hacia capa intermedia}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
    	\centering
        \includegraphics[width=0.89\textwidth]{fig/L2W_ARGOV2.png}
        \caption{Pesos hacia capa de salida}
    ...
    \begin{subfigure}[b]{0.33\textwidth}
    	\centering
        \includegraphics[width=0.81\textwidth]{fig/L2T_ARGOV2.png}
        \caption{Retardos hacia capa de salida}
